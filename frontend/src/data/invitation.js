...
export const wedding = {
  ...
  transport: {
    car: {
      ...
      lines: [
        '<bold>경부고속도로</bold>',
        '반포IC 종합운동장 방향 직진 > 교보생명 > 차병원 > 봉은사 > 아셈타워 직진 > <bold>노블발렌티 삼성점</bold>',
        '<bold>서울 서부, 강북 지역</bold>',
        '영동대교 남단 교차로 무역센터 방향 > 아크로 삼성 아파트 > 아셈타워 앞 봉은사 사거리 좌회전 > <bold>노블발렌티 삼성점</bold>',
        '<bold>서울 동남부 지역</bold>',
        '2호선 삼성역 무역센터 교차로 영동대교 방향 > 아셈타워 앞 봉은사 사거리에서 우회전 > <bold>노블발렌티 삼성점</bold>',
      ],
    },
    subway: {
      label: '지하철',
      lines: [
        '<bold>9호선 봉은사역 4번 출구 도보 약 4분</bold>',
        '<bold>2호선 삼성역 7번 출구 도보 약 15분</bold> 버스 - 강남 01, 3417번 버스 환승 <bold>노블발렌티 정류장 하차</bold>',
      ],
    },
    shuttle: {
      label: '셔틀버스',
      lines: ['<bold>봉은사역 5번 출구 우측 50~60m (5분 간격)</bold>'],
    },
    bus: {
      label: '버스',
      lines: [
        '<bold>9호선 봉은사역 3번 출구 삼성 1파출소</bold>',
        '간 선 143, 146, 301, 343, 345, 401',
        '지 선 2413, 2415, 3217, 3414, 4318',
        '직 행 9407, 9507, 9607',
      ],
    },
  },
